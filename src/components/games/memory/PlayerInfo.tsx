...
const PlayerInfo: FC<PlayerInfoProps> = ({ movesRemaining, score, pairsFound, totalPairs }) => {
    return (
        <section className="grid grid-cols-3 gap-3 rounded-xl border border-[#465a7a] border-l-[3px] border-l-[#e34a7a] bg-[#172238] p-4 text-white lg:grid-cols-1 short-landscape:grid-cols-1 short-landscape:gap-2 short-landscape:p-3">
            ...
            <section className="text-center lg:text-left short-landscape:text-left">
                ...
                <p className="m-0 text-2xl font-black text-[#f188aa] short-landscape:text-xl" aria-live="polite">{pairsFound}/{totalPairs}</p>
            </section>
